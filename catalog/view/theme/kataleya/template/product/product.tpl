      ...
      <div class="row cube">
              ...
              <form class="form-horizontal" id="form-review">
                ...
                <div class="form-group required">
                  <div class="col-sm-12 rating">
                    <label class="control-label"><?php echo $entry_rating; ?></label><span><?php echo $entry_bad; ?></span>
        ...
        <div class="right-side">
          ...
          <ul class="list-unstyled">
            ...
            <?php } ?>
            <?php if ($width != 0 && $length != 0 && $height != 0){ ?>
                <li>Размер: <?php echo round($width, 2).'x'.round($length, 2).'x'.round($height, 2).'h'; ?></li>
            <?php } ?>
            <?php if ($reward) { ?>
